package com.user.registration.features.authentication.filter;
...
public class AuthenticationFilter extends HttpFilter{
    ...
    protected void doFilter(HttpServletRequest request, HttpServletResponse response, FilterChain chain) throws IOException, ServletException {
        response.addHeader("Access-Control-Allow-Origin", "x");
        response.addHeader("Access-Control-Allow-Methods", "GET, POST, PUT, DELETE, OPTIONS");
        response.addHeader("Access-Control-Allow-Origin", "Content-Type, Authorization");
        ...
        try {
            ...
            if (jsonWebTokenService.isTokenBlacklisted(token)) {
